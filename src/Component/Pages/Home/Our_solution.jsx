                ...
                <div class="container-lg container-fluid">
                    <div className='mb-5'>
                        <div className="section-title three text-animation row">
                            ...
                            <div className='about-our-company col-lg-8 our-solution-style-3'>
                    ...
                    <div class="row g-lg-4" id="scroll-progress">
                        <div class="col-lg-6">
                            <div class="progress-wrapper">
                                <p class="pct">0%</p>
                                <div class="counter-wrap">
                                    <p class="steps">Step</p>
                                    <p id="pageIndicator">0/4</p>
                                </div>
                                <svg class="complete" width="340" height="340">
                                    <defs>
                                ...
                                <div class="single-process-static">
                                    <div class="single-process">
                                        ...
                                        <div class="content">
                                            ...
                                            <p>If applicable, create a user-centric design for software interfaces, websites, or applications.</p>
                                            <ul>
                                                <li>
                                                    <i class="bi bi-plus"></i>
                                                    Wireframing </li>
